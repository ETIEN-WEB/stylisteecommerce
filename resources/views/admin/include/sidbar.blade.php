<div class="side-header show"> 
    ...
    <div class="side-header-inner custom-scroll">
        ...
        <nav class="side-header-menu" id="side-header-menu">
            <ul>
                <li class="has-sub-menu"><a href="#"><i class="ti-home"></i> <span>Accueil</span></a>
                </li>
                ...
                <li class="has-sub-menu"><a href="#"><i class="ti-shopping-cart"></i> <span>Produits</span></a>
                    <ul class="side-header-sub-menu">
                        <li><a href="{{ route('admin.produit.create') }}"><span>Ajouter un produit </span></a></li>
                        ...
                        <li><a href="{{ route('admin.commande.index') }}"><span>Liste Commande</span></a></li>
