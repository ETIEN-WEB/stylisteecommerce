                            ...
                            <div class="col-auto">
                                ...
                                <ul class="header-notification-area">
                                    ...
                                    <li class="adomx-dropdown position-relative col-auto">
                                        <a class="toggle" href="#"><img class="lang-flag" src="{{ asset ('backend/images/flags/flag-1.jpg')}}" alt=""><i class="zmdi zmdi-caret-down drop-arrow"></i></a>

                                        <!-- Dropdown -->
                                        <ul class="adomx-dropdown-menu dropdown-menu-language">
                                            <li><a href="#"><img src="{{ asset ('backend/images/flags/flag-1.jpg')}}" alt=""> English</a></li>
                                            <li><a href="#"><img src="{{ asset ('backend/images/flags/flag-2.jpg')}}" alt=""> Japanese</a></li>
                                            <li><a href="#"><img src="{{ asset ('backend/images/flags/flag-3.jpg')}}" alt=""> Spanish </a></li>
                                            <li><a href="#"><img src="{{ asset ('backend/images/flags/flag-4.jpg')}}" alt=""> Germany</a></li>
                                        </ul>
                                        ...
                                        <div class="adomx-dropdown-menu dropdown-menu-mail">
                                            ...
                                            <div class="body custom-scroll">
                                                <ul>
                                                    <li>
                                                        <a href="#">
                                                            <div class="image"><img src="{{ asset ('backend/images/avatar/avatar-2.jpg')}}" alt=""></div>
                                                            <div class="content">
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <div class="image"><img src="{{ asset ('backend/images/avatar/avatar-1.jpg')}}" alt=""></div>
                                                            <div class="content">
                                ...
                                <table class="table table-vertical-middle table-selectable">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><img src="{{ asset ('backend/images/product/list-product-1.jpg')}}" alt="" class="table-product-image rounded-circle"></td>
                                        ...
                                        <tr class="selected">
                                            <td class="selector"><label class="adomx-checkbox"><input type="checkbox"> <i class="icon"></i></label></td>
                                            <td><img src="{{ asset ('backend/images/product/list-product-2.jpg')}}" alt="" class="table-product-image rounded-circle"></td>
                                            <td><a href="#">Microsoft surface pro 4</a></td>
                                            <td>#MSP40022</td>
                                            <td>05 - Products</td>
                                            <td>$60000000.00</td>
                                        ...
                                        <tr>
                                            <td class="selector"><label class="adomx-checkbox"><input type="checkbox"> <i class="icon"></i></label></td>
                                            <td><img src="{{ asset ('backend/images/product/list-product-3.jpg')}}" alt="" class="table-product-image rounded-circle"></td>
                                            <td><a href="#">Microsoft surface pro 4</a></td>
                                            <td>#MSP40022</td>
                                            <td>05 - Products</td>
                                            <td>$60000000.00</td>
                                        ...
                                        <tr>
                                            <td class="selector"><label class="adomx-checkbox"><input type="checkbox"> <i class="icon"></i></label></td>
                                            <td><img src="{{ asset ('backend/images/product/list-product-4.jpg')}}" alt="" class="table-product-image rounded-circle"></td>
                                            <td><a href="#">Microsoft surface pro 4</a></td>
                                            <td>#MSP40022</td>
                                            <td>05 - Products</td>
                                            <td>$60000000.00</td>
                                ...
                                <ul class="widget-chat-list">
                                    <li>
                                        <div class="widget-chat">
                                            ...
                                            <div class="body">
                                                <div class="image"><img src="{{ asset ('backend/images/comment/comment-1.jpg')}}" alt=""></div>
                                                <div class="content">
                                    ...
                                    <li>
                                        <div class="widget-chat">
                                            ...
                                            <div class="body">
                                                <div class="image"><img src="{{ asset ('backend/images/comment/comment-2.jpg')}}" alt=""></div>
                                                <div class="content">
                                    ...
                                    <li>
                                        <div class="widget-chat">
                                            ...
                                            <div class="body">
                                                <div class="image"><img src="{{ asset ('backend/images/comment/comment-3.jpg')}}" alt=""></div>
                                                <div class="content">
