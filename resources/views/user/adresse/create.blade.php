...
@section('content')
			...
			<div class="container account-container custom-account-container">
				<div class="row">
					...
					<div class="col-lg-9 order-lg-last order-1 tab-content">
                        ...
                        {{-- @include('user.adresse.include.index_include')  --}}
                        <!-- End .tab-pane -->
                        @include('user.adresse.include.create_include') 
                        <!-- End .tab-pane -->
		...
		<script>
			...
			$(document).ready(function(){
				//Traiter formulaire ajouter d'information perso
				...
				//Traiter formulaire ajouter adresse
