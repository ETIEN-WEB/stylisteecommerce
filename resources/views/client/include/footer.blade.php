            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6 pb-2 pb-sm-0">
                    <div class="widget">
                        ...
                        <a href="demo1.html">
                            <img src="{{asset ('frontend/images/logo-footer.png')}}" alt="Logo" class="logo-footer">
                        </a>
        ...
        <div class="footer-bottom d-sm-flex align-items-center">
            ...
            <div class="footer-right ml-auto mt-1 mt-sm-0">
                <div class="payment-icons">
                    <span class="payment-icon visa" style="background-image: url(frontend/images/payments/payment-visa.svg)"></span>
                    <span class="payment-icon paypal" style="background-image: url(frontend/images/payments/payment-paypal.svg)"></span>
                    <span class="payment-icon stripe" style="background-image: url(frontend/images/payments/payment-stripe.png)"></span>
                    <span class="payment-icon verisign" style="background-image:  url(frontend/images/payments/payment-verisign.svg)"></span>
                </div>
            </div>
        </div>
    </div>
